...
<div class="card" data-state="#about">
  <div class="card-header">
    <div class="card-cover" style="background-image: url('{{asset('/img/info/igor.jpg')}}')"></div>
    <img class="card-avatar" src="{{asset('/img/info/igor.jpg')}}" alt="avatar" />
    <h1 class="card-fullname">Igor A. Batista</h1>
    <h2 class="card-jobtitle">Desenvolvedor</h2>
  </div>
  <div class="card-main">
    <div class="card-section is-active" id="about">
      ...
      <div class="card-social">
        <a href="https://facebook.com/igorarrudabatista" target="_blank"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="https://instagram.com/igorarrudabatista"target="_blank"><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="https://www.linkedin.com/in/igor-de-arruda-batista-62ab5538/"target="_blank"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="card-section" id="contact">
      <div class="card-content">
        <div class="card-subtitle">CONTATO</div>
    ...
    <div class="card-buttons">
      ...
      <button data-section="#experience">EXPERIÊNCIA</button>
