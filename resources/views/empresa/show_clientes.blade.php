...
<div class="app-content">
  <div class="app-content-header">
    ...
    <a href="{{asset('/empresa/show_clientes')}}">
      <button class="btn">Limpar pesquisa</button> </a>
      @else
      <h1 class="app-content-headerText">Clientes</h1>
    ...
    <a href="{{asset('/empresa/form_empresa_cliente')}}"> <button class="app-content-headerButton">Adicionar Cliente</button> </a>
  </div>
  <div class="app-content-actions">
    <form action="{{asset('/empresa/show_clientes')}}" method="GET">
      <input class="search-bar" placeholder="Nome Cliente:" id="search" name="search" type="text">
...
@foreach($criar_empresa as $empresa_clientes )
      ...
      <div class="products-row">
        <button class="cell-more-button">
          ...
          <div class="product-cell image">
          <a href="{{asset('/empresa/edit/')}}/{{$empresa_clientes->id}}"> 
            <img src="{{asset('/img/empresa/')}}/{{$empresa_clientes->image}}" > </a>
        ...
        <a href="{{asset('/empresa/edit/')}}/{{$empresa_clientes->id}}" class="btn btn-info edit-btn">
           <ion-icon name="create-outline"></ion-icon> Editar </a>&nbsp
